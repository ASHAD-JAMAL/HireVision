  ...
  useEffect(() => {
    ...
    const intersectionCallback = (entries) => {
      ...
      if (isIntersecting && window.innerWidth >= 640) {
        // Disable scroll handler on mobile devices
...
function Testimonial() {
  ...
  return (
    <div className="flex flex-col justify-center items-center bg-[#f3f7fb] sm:py-10 px-4 md:px-0">
      <div className="md:py-5 py-10 flex flex-col justify-center items-center space-y-4">
        ...
        <div>
          <h1 className="md:text-[60px] text-3xl text-[#02015A] font-bold leading-tight text-center">
      ...
      <div id="slider-container" className="w-full relative overflow-hidden">
        ...
        >
          {/* Responsive Card */}
          <div className="card bg-[#ece5ff] w-full sm:w-1/2 md:w-1/3 lg:w-1/3 p-4 md:h-[400px]">
            <div className="card-body h-full flex flex-col justify-between">
              <p className="text-[#033bac] font-medium text-[28px]">
              ...
              <div className="card-actions flex items-center">
                <div className="avatar items-center space-x-4">
                  ...
                  <p className="text-[#033bac] text-sm">
          ...
          <div className="card bg-[#fbf7b8] w-full sm:w-1/2 md:w-1/3 lg:w-1/3 p-4 md:h-[400px] ">
            <div className="card-body h-full flex flex-col justify-between">
              <p className="text-[#033bac] font-medium text-[28px]">
          ...
          <div className="card bg-[#fbf7b8] w-full sm:w-1/2 md:w-1/3 lg:w-1/3 p-4 md:h-[400px]">
            <div className="card-body h-full flex flex-col justify-between">
              ...
              <div className="card-actions flex items-center">
                <div className="avatar space-x-5 items-center">
                  <div className="w-16 rounded-full">
                    <img src="https://img.daisyui.com/images/stock/photo-1534528741775-53994a69daeb.webp" />
                  </div>
                  <p className="text-[#033bac] text-sm">
      ...
      <div className="w-fit mb-10">
        <button className="flex md:text-lg px-5 py-3 border border-[rgb(0,0,254)] text-[rgb(0,0,254)] hover:bg-[rgb(0,0,254)] rounded-lg hover:duration-300 items-center gap-3 group">
          <p className="group-hover:-translate-x-1 duration-300 group-hover:text-white">
            More Stories
          </p>
          <FaArrowRightLong className="text-[22px] group-hover:translate-x-1 duration-300 group-hover:text-white" />
        </button>
      </div>
    </div>
  );
